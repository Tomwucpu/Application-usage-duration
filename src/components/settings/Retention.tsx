  ...
  return (
    <div className="pt-4 border-t border-slate-100 dark:border-[#3f3f41]">
      ...
      <div className="space-y-3">
        <label className="flex items-center gap-3 p-3 rounded-md bg-slate-50 dark:bg-[#1d1d20] hover:bg-slate-100 dark:hover:bg-[#2d2d31] border border-[#e2e8f0] dark:border-[#3f3f41] cursor-pointer transition-colors">
